...
<body>
    ...
    <div class="container">
        ...
        <table>
            <tr>
                <td><h1 class="text-center" style="padding-top: 40px; padding-bottom: 10px;">Data Produk</h1></td>
            </tr>
        </table>
        </center>
        <br>
        ...
        <table id="MyTable" class="table table-striped table-bordered text-center">
			...
			<tbody>
				<tr>				
                <td><?php echo $no?></td>
					<td align="center"><?php echo "<img src='images/$data[file_gambar]' width='270' height='290' />";?></td>
					<td style="width: 1px;"><?php echo $data['id_kategori']?></td>
					<td><?php echo $data['nama_produk']?></td>
					<td><?php echo $data['stok']?></td>
					<td><?php echo $data['harga_sewa']."/Hari"?></td>
                    <td  style="width: 150px;">
                        <a href="edit_data_produk.php?id=<?php echo $data['id']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_produk.php?id=<?php echo $data['id']; ?>" class="btn btn-danger">Delete</a>
                    </td>
