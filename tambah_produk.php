...
<body>
    ...
    <div class="container">
        ...
        <table>
            <tr>
                <td><h1 class="text-center" style="padding-top: 40px; padding-bottom: 10px;">TAMBAH PRODUK</h1></td>
            </tr>
        </table>
        </center>
        ...
        <form action="tambah_produk_proses.php" method="post">
            ...
            <div class="form-group">
                <label>Stok</label>
                <input type="number" name="stok" class="form-control" placeholder="Masukkan Stok Yang Tersedia">
            </div>
            <div class="form-group">
                <label>Harga Sewa</label>
                <input type="number" name="harga_sewa" class="form-control" placeholder="Masukkan Harga Sewa">
            </div>
            <div class="form-group">
                <label>Gambar</label>
