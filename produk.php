...
<body>
    ...
    <div class="items">
        ...
        <table>
            <tr>
                <td><h1 class="text-center" style="padding-top: 40px; padding-bottom: 10px;">KATEGORI PRODUK</h1></td>
            </tr>
        </table>
        </center>
        <div class="container">
            <div class="container">
                <center>
                <table class="pt-4" cellpadding="10">
                    <tr>
                        <td><a href="kamera.php"><img src="images/kamera.png" style="width: 370px; height: 370px;"></a></td>
                        <td><a href="lensa.php"><img src="images/lensa.jpg" style="width: 350px; height: 350px;"></a></td>
                    </tr>
                    <tr>
                        <td><a href="kamera.php"><h2 class="text-center">Kamera</h2></a></td>
                        <td><a href="lensa.php"><h2 class="text-center">Lensa</h2></a></td>
                    </tr>
                </table>
                </center>
            </div>
