...
<body>
    ...
    <div class="container">
        ...
        <table>
            <tr>
                <td><h1 class="text-center" style="padding-top: 40px; padding-bottom: 20px;">CRUD Admin</h1></td>
            </tr>
        </table>
        
        <img src="images/edit.png" width='220' height='250' style="align-items:center;">

        <table cellpadding="30">
            <tr>
                <td><a class="btn btn-primary" href="data_produk.php">Data Produk</a></td>
                <td><a class="btn btn-primary" href="transaksi.php">Data Transaksi</a></td>
            </tr>
        </table>
        </center>
    </div>
